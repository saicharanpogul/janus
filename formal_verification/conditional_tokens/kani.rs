// ---- GENERATED BY QEDGEN ---- spec-hash:0d65c0998b734595
//
...
fn verify_initialize_market_preserves_yes_no_paired_while_active() {
    ...
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_initialize_market_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_split_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_merge_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_resolve_yes_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_resolve_no_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_redeem_yes_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_redeem_no_preserves_vault_tracks_yes() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_initialize_market_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_split_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_merge_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_resolve_yes_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_resolve_no_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_redeem_yes_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_redeem_no_preserves_vault_tracks_no() {
    let mut s: State = kani::any();
    kani::assume(yes_no_paired_while_active(&s));
    kani::assume(vault_tracks_yes(&s));
    kani::assume(vault_tracks_no(&s));
